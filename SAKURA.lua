...
SAKURA_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
SAKURA_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
SAKURA_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
SAKURA_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
SAKURA_Msg = 'رب التفاعل✔️😍'  
end 
return SAKURA_Msg 
end
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..SAKURAk..''..SAKURA..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
⚜↬  SAKURA TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🔱↬[Channel SAKURA](t.me/SAKURAV15) 

🔰↬[DEVELOPER](t.me/MMLMMM)

📌↬[To talk to us](t.me/SAKURATEM_BOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAKURAV15')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAKURAV15')..') \n🔘| تـم قفـل التاك بالكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SAKURASR/Files_SAKURA/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات ساكورا\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس ساكورا ↓\n".."📮| [اضغط هنا لدخول](t.me/SAKURAV15) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SAKURASR/Files_SAKURA/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SAKURA.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس ساكورا\n") 
end
return false
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SAKURAV15')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
