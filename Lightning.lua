...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Lightning.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("MIK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Lightning -X kill
screen -S Lightning ./Lightning
done
]])  
file:close() 
...
local Lightning_Msg = ''  
if msgs < 100 then 
Lightning_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Lightning_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Lightning_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Lightning_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Lightning_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Lightning_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Lightning_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Lightning_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Lightning_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Lightning_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Lightning_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Lightning_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Lightning_Msg = 'رب التفاعل'  
end 
return Lightning_Msg 
end
...
function plugin_Lightning(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Lightning and msg then
pre_msg = plugin.Lightning(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function THEOLightning(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Lightning_Msg) 
return false  
end 
if text then    
...
file = download_to_file(url1,'Lightning.webp')
print('TIMESSSS')
local Lightning = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. Lightning .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'Lightning.webp' .. '"'
io.popen(curl)
end

if text == 'تحديث السورس' and SudoBot(msg) then 
os.execute('rm -rf Lightning.lua')
os.execute('https://github.com/shado55/Lightning')
...
send(msg.chat_id_, msg.id_,'⌔︙عدد المجموعات الان » { '..#group..' }'..Lightningk..''..Lightning..'\n*-الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,'['..Lightning_Msg[math.random(#Lightning_Msg)]..']') 
return false
end
...
Lightning = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Lightning)
...
--------------------------------------------------------------------------------------------------------------
THEOLightning(data.message_,data)
plugin_Lightning(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local LightningAbot = database:get(bot_id.."Lightning1:Add:Filter:Rp2"..text..result.chat_id_)   
if LightningAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌔︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..LightningAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local Lightning1_Msg = database:get(bot_id.."Lightning1:Add:Filter:Rp2"..text..result.chat_id_)   
if Lightning1_Msg then    
send(msg.chat_id_, msg.id_,"⌔︙"..Lightning1_Msg)
